...
const experienceData = [
	{
		...
		date: '( 2020.11 - 현재 )',
		description: [
			'FMS(Fleet Management System) 프로젝트 3회 진행 (React, ReactNative, Node)',
			'세종 스마트시티 실내주차장 내비게이션 라이브러리 개발 (Android Kotlin)',
			'단말 연동을 통한 홈 카메라 앱(4K Wi-Fi 홈 카메라) 개발 (Android Kotlin)',
			'일본 전역의 대중교통 정보를 종합적으로 안내하는 내비게이션 앱 운영 및 유지보수 진행 (Android Java)',
		],
	},
	{
		title: (
